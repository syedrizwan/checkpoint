        ...
        <div class="animate form login_form">
          <section class="login_content">
            ...
            <form method="POST" action="{{ route('login') }}">
                @csrf
              <h1>Penta A Checkpoint</h1>
              <div>
                <input type="email" name="email" id="email" class="form-control" placeholder="E-Mail Address" required autofocus value="{{ old('email') }}" />
              </div>
              <div>
              ...
              <div class="separator">
                ...
                <div>
                  ...
                  <p>©2019 All Rights Reserved. Penta A!</p>
                </div>
              </div>
            </form>
          </section>
